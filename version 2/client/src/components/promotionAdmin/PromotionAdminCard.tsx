...
import type { FormattedTime, PromotionAdminCardProps } from '../../types/promotion.type';

const PromotionAdminCard: React.FC<PromotionAdminCardProps> = ({subdesc, title, desc, price, sale, link, time, src, id, edit}) => {
